from models.qualityDataListen import QualityDataAAS, SampleData, QualityFeatureName, QualityData, SampleBatch, Features, \
    Result, References, ProductionProcedures
...
quality_data_submodel = QualityData(id_='Submodel', id_short='QualityDataSubmodel', description='xyz',
                                    semantic_id='http://www.google.de/1',
                                    production_procedures=[production_procedures1])

example2_quality_data_aas = QualityDataAAS(id_='QualityDataAAS', description='xyz', id_short='QualityDataAAS',
                                           quality_data=quality_data_submodel, semantic_id='http://www.google.de/1')
